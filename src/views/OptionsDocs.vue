      ...
      optionGroups: [
        {
          ...
          items: [
            ...
            { name: 'rowHeight', type: 'number / 78', description: '默认资源行高度，单行可用 record.height 覆盖。' },
        ...
        },
        {
          ...
          items: [
            ...
            { name: 'task.draggable', type: 'boolean', description: '单任务拖拽开关，优先级高于 taskBar.draggable。' },
        ...
        },
        {
          ...
          items: [
            ...
            { name: 'barStyle', type: 'object | function', description: '普通任务条样式。' },
            ...
            { name: 'draggable', type: 'boolean | function / true', description: '是否允许拖拽任务。' },
        ...
        {
          title: 'dependency',
          description: '任务依赖线。点击任务时可只显示当前连接组，其他任务可透明弱化。',
          items: [
            { name: 'links', type: 'GanttTaskLink[] / []', description: '连接线数组。' },
            { name: 'linkLineStyle', type: 'line style', description: '全局连接线样式。' },
            { name: 'showLinks', type: 'boolean / false', description: '是否默认显示所有连接线。false 时点击任务显示对应连接组。' },
